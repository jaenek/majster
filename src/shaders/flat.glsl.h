...
/*
    ...
    Cmdline: sokol-shdc -i /home/jaenek/workspace/c/majster/src/shaders/flat.glsl -o /home/jaenek/workspace/c/majster/src/shaders/flat.glsl.h -l glsl330

    Overview:

        Shader program 'flat':
            Get shader desc: flat_shader_desc(sg_query_backend());
            Vertex shader: vs
                Attribute slots:
                    ATTR_vs_position = 0
                    ATTR_vs_texcoord = 1
    ...
    Shader descriptor structs:
        ...
        sg_shader flat = sg_make_shader(flat_shader_desc(sg_query_backend()));
...
#define ATTR_vs_inst_position (2)
#define ATTR_vs_size (3)
#define ATTR_vs_color (4)
#define SLOT_tex (0)
...
/*
    ...
    void main()
    {
        gl_Position = mat4(vs_params[0], vs_params[1], vs_params[2], vs_params[3]) * vec4((position * size) + inst_position, 0.0, 1.0);
        out_color = color;
        uv = texcoord;
    }
    
*/
static const char vs_source_glsl330[460] = {
    ...
    0x69,0x6e,0x73,0x74,0x5f,0x70,0x6f,0x73,0x69,0x74,0x69,0x6f,0x6e,0x3b,0x0a,0x6f,
    ...
    0x63,0x6f,0x6c,0x6f,0x72,0x3b,0x0a,0x6f,0x75,0x74,0x20,0x76,0x65,0x63,0x32,0x20,
    ...
    0x28,0x70,0x6f,0x73,0x69,0x74,0x69,0x6f,0x6e,0x20,0x2a,0x20,0x73,0x69,0x7a,0x65,
    0x29,0x20,0x2b,0x20,0x69,0x6e,0x73,0x74,0x5f,0x70,0x6f,0x73,0x69,0x74,0x69,0x6f,
...
static const char fs_source_glsl330[177] = {
    ...
    0x65,0x63,0x34,0x20,0x6f,0x75,0x74,0x5f,0x63,0x6f,0x6c,0x6f,0x72,0x3b,0x0a,0x0a,
    0x76,0x6f,0x69,0x64,0x20,0x6d,0x61,0x69,0x6e,0x28,0x29,0x0a,0x7b,0x0a,0x20,0x20,
    0x20,0x20,0x66,0x72,0x61,0x67,0x5f,0x63,0x6f,0x6c,0x6f,0x72,0x20,0x3d,0x20,0x74,
    0x65,0x78,0x74,0x75,0x72,0x65,0x28,0x74,0x65,0x78,0x2c,0x20,0x75,0x76,0x29,0x20,
    0x2a,0x20,0x6f,0x75,0x74,0x5f,0x63,0x6f,0x6c,0x6f,0x72,0x3b,0x0a,0x7d,0x0a,0x0a,
    0x00,
};
#if !defined(SOKOL_GFX_INCLUDED)
  #error "Please include sokol_gfx.h before flat.glsl.h"
#endif
static inline const sg_shader_desc* flat_shader_desc(sg_backend backend) {
  if (backend == SG_BACKEND_GLCORE33) {
    ...
    if (!valid) {
      ...
      desc.attrs[3].name = "size";
      desc.attrs[4].name = "color";
